...
export default Screeen11 = ({route, navigation}) => {
            ...
            .map(item => (
              <View
                ...
                <View style={{flexDirection: 'row', alignSelf: 'center'}}>
                  <TouchableNativeFeedback>
                    <View
                      style={[styles.MemButton, {backgroundColor: '#d0d0d0'}]}>
                      <Text style={[styles.MemText, {color: '#000'}]}>
                        Cancel
                      </Text>
                    </View>
                  </TouchableNativeFeedback>
                  <TouchableNativeFeedback>
                    <View
                      style={[styles.MemButton, {backgroundColor: '#0099ff'}]}>
                      <Text style={[styles.MemText, {color: '#ffffff'}]}>
                        E-Receipt
                      </Text>
                    </View>
                  </TouchableNativeFeedback>
