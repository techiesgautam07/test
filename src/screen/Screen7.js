        ...
        <SafeAreaView>
            <ScrollView>
                ...
                <View style={{
                    ...
                    <Text style={[styles.navText, { color: "#0E50FA" }]}>Upcomming</Text>
                ...
                <View style={styles.ItemBox} key={item.sn}>
                    <View style={{width:330,height:40,borderBottomWidth:1, borderColor:"#C9C9C9", paddingVertical:10}}>
                        ...
                        <Image source={require('./images/prof1.png')} style={{width:100,height:100,borderRadius:10,margin:10,left:-110}} />
